### **Название задачи: MVP системы мониторинга свиноводческих ферм (PigMonitoring)**
### **Автор: Алесандр Сосорев**
### **Дата: 01.02.2026**
...
* **Интеграции:** Использование стандартных протоколов (ONVIF, MQTT, Modbus) для поддержки оборудования разных вендоров.
