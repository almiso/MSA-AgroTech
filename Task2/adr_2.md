...
* **Причина отказа:** Постоянные HTTP-вызовы создают накладные расходы. Выбран паттерн Transactional Outbox с пакетной отправкой (Sync Service) для экономии трафика при нестабильном Wi-Fi.
